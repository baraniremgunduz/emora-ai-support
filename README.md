...
**Ücretsiz mi?**
Evet, temel özellikler ücretsizdir. Premium özellikler (Duygu analizi, sınırsız mesaj) için abonelik seçenekleri mevcuttur.

**Teknik Bir Sorun mu Var?**
- Uygulamayı kapatıp açın.
- İnternet bağlantınızı kontrol edin.
- [GitHub Issues üzerinden bildirin](https://github.com/baraniremgunduz/emora-ai-support/issues/new)

**Premium Abonelik İptali:**
iOS Ayarlar > Apple ID > Abonelikler bölümünden yönetebilirsiniz.

---

## 📧 İletişim

Sorularınız için bizimle GitHub üzerinden iletişime geçebilirsiniz.

## 📱 Uygulama Bilgileri
- **Platform**: iOS (Gold Standard)
- **Minimum iOS**: 15.1+
- **Geliştirici**: Baran Gündüz
